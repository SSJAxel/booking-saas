...
// spread across several files that are easy to forget to update.
//
// Shared by two very different audiences: HelpManual.jsx (the modal inside the authenticated
// dashboard, for owners who already signed up) and pages/AdminManualPage.jsx (the public page
// linked from /manual-de-uso, for visitors deciding whether to sign up at all — same content, no
// login needed to read it, since none of it is sensitive).
