 ...
 * <pre>
 * Plan      maxProf(incl)  maxProducts  maxBranches  maxServices  maxAppt/semana  MP     WhatsApp  Loyalty  Commissions  extraProfPrice
 * TRIAL         2               5            2            6            null      false   true      false    false        —
 * PERSONAL      1               0            1            3            20        false   false     false    false        —
 * BASIC         2               5            2            6            null      false   true      false    false        3000.00
 * PRO           5              10            3            8            null      true    true      true     true         2500.00
 * MAX          10              20            4           12            null      true    true      true     true         2000.00
 * </pre>
 * {@code loyaltyRewardsEnabled}/{@code commissionsEnabled} (both PRO/MAX only) gate
 * {@code Tenant#loyaltyRewardsEnabled}/{@code Tenant#commissionsEnabled} — same "premium
 * differentiator" tier split as {@code mercadoPagoEnabled}, per the founder's own call when these
 * features were designed (2026-08-14 WhatsApp thread relaying a competitor's client's feature
 * requests).
...
public enum PlanTier {
	...
	BASIC(2, 5, 2, 6, null, false, true, false, false, null, new BigDecimal("3000.00")),
	...
	PRO(5, 10, 3, 8, null, true, true, true, true, null, new BigDecimal("2500.00")),
	...
	MAX(10, 20, 4, 12, null, true, true, true, true, null, new BigDecimal("2000.00"));
	...
	PlanTier(int maxProfessionals, Integer maxProducts, int maxBranches, int maxServices,
			...
			boolean loyaltyRewardsEnabled, boolean commissionsEnabled, BigDecimal monthlyPrice,
			BigDecimal extraProfessionalPrice) {
